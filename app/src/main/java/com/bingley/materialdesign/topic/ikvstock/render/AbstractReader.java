package com.bingley.materialdesign.topic.ikvstock.render;
...
import com.bingley.materialdesign.topic.ikvstock.entry.EntrySet;
...
public abstract class AbstractReader {
    private static final String TAG = "AbstractReader";
