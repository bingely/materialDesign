...
public class PaletteActivity extends BaseSwipebackActivity {
    ...
    protected void initWidget() {
        ...
        main_vp_container.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                Toast.makeText(PaletteActivity.this, "刷新"+position, Toast.LENGTH_SHORT).show();
            }
