package com.bingley.materialdesign.topic.lunbo;
...
import static com.bingley.materialdesign.R.id.pointGroup;
import static com.bingley.materialdesign.R.id.viewPager;
...
public class LunboFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.cycle_rotation_layout;
    }
    ...
    protected void initWidget(View root) {
        ...
        mImageDesc.setText(imageDescriptions[0]);
        ...
        for (int i = 0; i <imageIds.length; i++) {
            ...
            point.setBackgroundResource(R.drawable.sel_point_bg);
            if(i==0){
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                //设置文字描述内容
                mImageDesc.setText(imageDescriptions[position]);
