...
public class ReconnectionManager {
    ...
    class ReconnectionThread extends Thread {
        ...
        public void run() {
            while(ReconnectionManager.this.isReconnectionAllowed() && !isInterrupted()) {
                ...
                try {
                    if (isReconnectionAllowed() && !isInterrupted()) {
                        if (reconnectHandler != null) {
                            ...
                            LogUtils.d("connection.connect()  reconnect");
                ...
                LogUtils.d("reconnManager shutdown");
            }
        }
    }
    ...
    private ConnectionListener connectionListener = new ConnectionListener() {
        ...
        public void connected(SocketConnection connection) {
             LogUtils.d("SocketConnection connected");
        ...
        public void connectionClosed() {
             LogUtils.d("SocketConnection connectionClosed");
        ...
        public void connectionClosedOnError(Exception exception) {
             LogUtils.d("SocketConnection connectionClosedOnError");
        ...
        public void reconnectingIn(int time) {
             LogUtils.d("SocketConnection reconnectingIn");

             LogUtils.d("reconnectingIn: " + time);
