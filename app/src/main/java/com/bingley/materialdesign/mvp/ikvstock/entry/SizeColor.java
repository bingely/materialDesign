...
package com.bingley.materialdesign.mvp.ikvstock.entry;

import com.bingley.materialdesign.R;
import com.bingley.materialdesign.mvp.ikvstock.alilgn.XMarkerAlign;
import com.bingley.materialdesign.mvp.ikvstock.alilgn.YLabelAlign;
import com.bingley.materialdesign.mvp.ikvstock.alilgn.YMarkerAlign;
...
public class SizeColor {
    ...
    private int highlightColor = R.color.red; // 高亮线条颜色 0xff1c232e        0xff282b34

    private float markerBorderSize = 2f; // MarkerView 边框大小
    private int markerBorderColor = 0xff4fb86a; // MarkerView 边框颜色  0xff282b34
    private float markerTextSize = 21; // MarkerView 字符大小
    private int markerTextColor = 0xff4fb86a; // MarkerView 字符颜色  0xff282b34
    ...
    private float candleBorderSize = 2f; // 蜡烛图矩形边框大小
    ...
    private int neutralColor = 0xffe05959; // 不涨不跌颜色0xff282b34   修改不涨不跌 颜色为上涨颜色（红色）

    private int portraitDefaultVisibleCount = 30; // 竖屏状态下的默认缩放倍数下显示多少个蜡烛图，横屏时会自动根据视图宽高变化比例计算，不需要手工设置
    private int zoomInTimes = 6; // 最多放大次数
    private int zoomOutTimes = 6; // 最多缩小次数
