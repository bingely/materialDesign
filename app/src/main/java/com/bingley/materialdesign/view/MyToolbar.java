...
public class MyToolbar extends RelativeLayout {
    ...
    // 映射传入的接口对象
    private TopbarClickListenrer mListener;
    ...
    public interface TopbarClickListenrer {
        // 左按钮点击事件
        void leftClick();
        // 右按钮点击事件
        void rightClick();
    ...
    // 暴露一个方法给调用者来注册接口回调
    // 通过接口来获得回调者对接口方法的实现
    public void setOnTopbarClickListener(TopbarClickListenrer mListener) {
